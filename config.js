...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY DAWENS-XD 🖤*",
...
BOT_NAME: process.env.BOT_NAME || "𝐃𝐀𝐖𝐄𝐍𝐒-𝐗𝐃",
// add bot name here for menu
STICKER_NAME: process.env.STICKER_NAME || "𝐃𝐀𝐖𝐄𝐍𝐒-𝐗𝐃",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴀᴡᴇɴꜱ ᴛᴇᴀᴍ*",
// add bot description    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/pbamxw.jpeg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *𝐃𝐀𝐖𝐄𝐍𝐒-𝐗𝐃* ⚡",
// add alive msg here 
