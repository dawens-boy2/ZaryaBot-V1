...
cmd({
    ...
    try {
        await reply("🔍 Checking for DAWENS-XD updates...");

        // Fetch the latest commit hash from GitHub
        const { data: commitData } = await axios.get("https://api.github.com/repos/dawens-xd/DAWENS-XD/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/DAWENS-BOY/DAWENS-XD/archive/main.zip", { responseType: "arraybuffer" });
